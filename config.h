...
static const char *fonts[]          = { "Hack:size=12", "Font Awesome 6 Free:style=Solid:pixelsize=12" };
...
static const Rule rules[] = {
	...
	{ "jetbrains-rider",	NULL,		NULL,	1 << 3,		0,		-1 },
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_e,	   	spawn,		SHCMD("telegram-desktop") },		// Run Telegram
